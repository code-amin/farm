  ...
  return (
    <>
      <div className="p-40  grid ">
        <button className="border-gray-500 w-[100px] 	border-2 py-3 right-0 font-medium text-sm px-5 mr-6 mt-16 ">
          <a href="/">⏎ Retour </a>
        </button>
        ...
        <button className="contact text-center  text-white py-3 right-0 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:outline-none font-medium text-sm px-5 mr-6 mt-16 ">
